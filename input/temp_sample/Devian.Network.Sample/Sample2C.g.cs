...
namespace Devian.Network.Sample
{
    // Direction: server_to_client

    /// <summary>
    /// Sample2C protocol container.
    /// </summary>
    public static partial class Sample2C
    {
        /// <summary>
        ...
        public sealed class CodecProtobuf : ICodec
        {
            ...
            private static void DecodePong(ReadOnlySpan<byte> data, Pong m)
            {
            ...
            private static void DecodeEchoReply(ReadOnlySpan<byte> data, EchoReply m)
            {
                var reader = new ProtoReader(data);
                while (reader.HasMore)
                {
        ...
        /// <summary>
        /// Abstract stub for Sample2C handlers.
