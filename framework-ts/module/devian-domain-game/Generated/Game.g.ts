...
export interface ITEM_HERO extends IEntityKey<string> {
    ...
    name_id: string;
    desc_id: string;
    initial_slot_00: EQUIP_SLOT_TYPE;
    initial_item_00: string;
    initial_slot_01: EQUIP_SLOT_TYPE;
    initial_item_01: string;
    initial_slot_02: EQUIP_SLOT_TYPE;
    initial_item_02: string;
    initial_slot_03: EQUIP_SLOT_TYPE;
    initial_item_03: string;
    getKey(): string;
}
...
export interface ITEM_HERO_LEVEL extends IEntityKey<number> {
    ...
    levelup_currency: CURRENCY_TYPE;
    levelup_price: number;
