...
export enum CommonErrorType {
    ...
    PURCHASE_NETWORK_UNAVAILABLE = 75,
    PURCHASE_PRODUCT_FETCH_FAILED = 76,
    PURCHASE_PRODUCT_NOT_FOUND = 77,
    PURCHASE_PURCHASE_IN_PROGRESS = 78,
    PURCHASE_PURCHASE_REQUEST_FAILED = 79,
    PURCHASE_RECENT_CALL_FAILED = 80,
    PURCHASE_RECENT_NOT_FOUND = 81,
    PURCHASE_RENTAL_ALREADY_ACTIVE = 82,
    PURCHASE_RENTAL_LATEST_CALL_FAILED = 83,
    PURCHASE_RENTAL_LATEST_NOT_FOUND = 84,
    PURCHASE_RESTORE_FAILED = 85,
    PURCHASE_SEASON_PASS_ALREADY_OWNED = 86,
    PURCHASE_STORE_FAILED = 87,
    PURCHASE_STORE_NOT_SET = 88,
    PURCHASE_UNAUTHENTICATED = 89,
    PURCHASE_UNSUPPORTED_PLATFORM = 90,
    PURCHASE_VERIFY_CALL_FAILED = 91,
    PURCHASE_VERIFY_FAILED_PRECONDITION = 92,
    PURCHASE_VERIFY_INVALID_ARGUMENT = 93,
    PURCHASE_VERIFY_REJECTED_UNKNOWN = 94,
    SAVEDATA_PAYLOAD_PARSE_FAILED = 95,
}
