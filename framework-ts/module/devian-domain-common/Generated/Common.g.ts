...
export enum CommonErrorType {
    ...
    PURCHASE_INIT_FAILED = 71,
    PURCHASE_INIT_REQUIRED = 72,
    PURCHASE_NETWORK_UNAVAILABLE = 73,
    PURCHASE_PRODUCT_FETCH_FAILED = 74,
    PURCHASE_RENTAL_LATEST_CALL_FAILED = 75,
    PURCHASE_RENTAL_LATEST_NOT_FOUND = 76,
    PURCHASE_STORE_FAILED = 77,
    PURCHASE_UNAUTHENTICATED = 78,
    PURCHASE_UNSUPPORTED_PLATFORM = 79,
    SAVEDATA_PAYLOAD_PARSE_FAILED = 80,
}
