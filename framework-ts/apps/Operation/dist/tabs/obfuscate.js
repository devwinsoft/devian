...
export function createObfuscateTab(container) {
  ...
  `;
    ...
    const input = section.querySelector('#obf-input');
    const output = section.querySelector('#obf-output');
    const btn = section.querySelector('#obf-btn');
    const status = section.querySelector('#obf-status');
