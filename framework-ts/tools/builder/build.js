...
class DevianToolBuilder {
    ...
    async processDomain(domainName, config) {
        ...
        // SSOT: skills/devian-data/33-string-table/SKILL.md - Hard Rule
    ...
    async copyDomainToTargets(domainName, config) {
        ...
        const stagingNdjson = path.join(this.tempDir, domainName, 'data', 'ndjson');
        const stagingPb64 = path.join(this.tempDir, domainName, 'data', 'pb64');
        // String Table staging paths (SSOT: skills/devian-data/33-string-table/SKILL.md)
...
`;
     ...
     * Rules (SSOT: skills/devian-core/03-ssot/SKILL.md):
     * - Lowercase
...
`;
    ...
    generateStringTableIdEditorCs(domainName, tableName) {
        ...
        lines.push('// SSOT: skills/devian-data/33-string-table/SKILL.md');
        lines.push('// </auto-generated>');
        lines.push('');
        lines.push('#if UNITY_EDITOR');
        lines.push('');
    ...
    async processSamplePackage(upmName) {
        ...
        // SSOT: skills/devian-unity-samples/02-samples-authoring-guide/SKILL.md
