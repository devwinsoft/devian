...
export function generateServerRuntime(groupName, protocols) {
    ...
    lines.push(`import type { IServerProtocolRuntime, SendFn, ICodec } from '@devian/network-server';`);
    ...
    lines.push(' */');
    lines.push(`export class ${groupName}ServerRuntime implements IServerProtocolRuntime {`);
    ...
    lines.push(' */');
    lines.push(`export function createServerRuntime(codec: ICodec): ${groupName}ServerRuntime {`);
    lines.push(`    return new ${groupName}ServerRuntime(codec);`);
    lines.push('}');
    lines.push('');
