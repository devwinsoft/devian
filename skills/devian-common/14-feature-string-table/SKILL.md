...
```json
{
  "domains": {
    "Common": {
      "tableDir": "Domains/Common/tables",
      "tableFiles": ["*.xlsx"],
      "stringDir": "Domains/Common/strings",
      "stringFiles": ["*.xlsx"]
    }
  }
}
...
- `LocalizedText.xlsx`: `input/Domains/Common/strings/LocalizedText.xlsx`
