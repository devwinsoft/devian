...
> **참고:** 이 정책은 `skills/devian-core/08-protobuf-serializer-policy/SKILL.md`의 "Unity Google.Protobuf.dll 정책"과 연계된다.
...
- Protobuf DLL 정책: `skills/devian-core/08-protobuf-serializer-policy/SKILL.md`
