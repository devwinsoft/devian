# 45-meta-message-system — Overview

Status: ACTIVE
AppliesTo: v10

MobileSystem 샘플의 메시지/트리거/메시지 저장 계층 개요다.

핵심:
- `MetaMessageManager`가 meta message trigger와 `MetaMessageStorage`를 소유한다.
...
| [10-meta-message-manager](../10-meta-message-manager/SKILL.md) | MetaMessageManager 설계 |
| [11-meta-message-trigger](../11-meta-message-trigger/SKILL.md) | MetaMessageTrigger 설계 |
| [14-meta-message-storage](../14-meta-message-storage/SKILL.md) | MetaMessageStorage 저장 모델 |
