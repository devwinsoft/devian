...
MobileSystem 샘플의 `AnalyzeManager` 설계 문서다.
...
|---|---|---|---|
| `AnalyzeManager.cs` | `upm/com.devian.samples/Samples~/MobileSystem/Runtime/Analyze/` | `Packages/com.devian.samples/Samples~/MobileSystem/Runtime/Analyze/` | `Assets/Samples/Devian Samples/{version}/MobileSystem/Runtime/Analyze/` |
