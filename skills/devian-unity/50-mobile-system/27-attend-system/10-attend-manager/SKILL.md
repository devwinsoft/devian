...
public sealed class AttendManager : CompoSingleton<AttendManager>
{
    ...
    public Task<CommonResult> ClaimAsync(string attendId, CancellationToken ct = default);
...
- UPM (정본):
  - `framework-cs/upm/com.devian.samples/Samples~/MobileSystem/Runtime/Attend/AttendManager.cs`
- Packages (sync):
  - `framework-cs/apps/UnityExample/Packages/com.devian.samples/Samples~/MobileSystem/Runtime/Attend/AttendManager.cs`
- Assets/Samples (import):
  - `framework-cs/apps/UnityExample/Assets/Samples/Devian Samples/{version}/MobileSystem/Runtime/Attend/AttendManager.cs`
