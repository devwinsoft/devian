...
에셋 생성: Unity Editor → Project 패널 → Create → Devian → MobileSystem → SaveData Settings
...
- SaveDataSettings.cs:
  - UPM (정본): `framework-cs/upm/com.devian.samples/Samples~/MobileSystem/Runtime/SaveData/SaveDataSettings.cs`
  - Packages (sync): `framework-cs/apps/UnityExample/Packages/com.devian.samples/Samples~/MobileSystem/Runtime/SaveData/SaveDataSettings.cs`
  - Assets/Samples (import): `framework-cs/apps/UnityExample/Assets/Samples/Devian Samples/{version}/MobileSystem/Runtime/SaveData/SaveDataSettings.cs`
