...
description: MobileSystem RemoteDataManager를 통해 VersionCheck(플랫폼 URL 기반)와 Server UTC 동기화(HTTP Date header)를 단일 경로로 제공할 때 사용한다.
---
...
- `VersionCheckAsync`: `MobileApplication.VersionCheckAOS/VersionCheckIOS` URL에서 JSON을 받아 버전 판정한다.
...
- UPM (정본): `framework-cs/upm/com.devian.samples/Samples~/MobileSystem/Runtime/RemoteData/RemoteDataManager.cs`
- Packages (sync): `framework-cs/apps/UnityExample/Packages/com.devian.samples/Samples~/MobileSystem/Runtime/RemoteData/RemoteDataManager.cs`
- Assets/Samples (import): `framework-cs/apps/UnityExample/Assets/Samples/Devian Samples/{version}/MobileSystem/Runtime/RemoteData/RemoteDataManager.cs`
