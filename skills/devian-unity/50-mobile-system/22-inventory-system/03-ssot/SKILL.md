...
`AbilityEquip` 필드 (구현: [12-game-ability](../../../21-domain-game-system/12-game-ability/SKILL.md)):
...
`AbilityCard` 필드 (구현: [12-game-ability](../../../21-domain-game-system/12-game-ability/SKILL.md)):
...
`AbilityUnitHero` 필드 (구현: [12-game-ability](../../../21-domain-game-system/12-game-ability/SKILL.md)):
