...
- `CreateDefaultCatalogs`는 인스턴스만 생성하고 `Initialize()`를 호출하지 않는다.
...
|--------|-----------|------|
| `CreateDefaultCatalogs` | X | `ShopManager.ensureCatalogInitialized`에서 bulk 생성 |
...
- UPM (정본): `framework-cs/upm/com.devian.samples/Samples~/MobileSystem/Runtime/Shop/Catalog/ShopCatalogFactory.cs`
- Packages (sync): `framework-cs/apps/UnityExample/Packages/com.devian.samples/Samples~/MobileSystem/Runtime/Shop/Catalog/ShopCatalogFactory.cs`
- Assets/Samples (import): `framework-cs/apps/UnityExample/Assets/Samples/Devian Samples/{version}/MobileSystem/Runtime/Shop/Catalog/ShopCatalogFactory.cs`
