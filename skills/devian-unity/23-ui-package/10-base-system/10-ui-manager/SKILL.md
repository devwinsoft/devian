...
### Code Path
```
framework-cs/upm/com.devian.foundation/Samples~/UIPackage/Runtime/Base/UIManager.cs
```
...
| `UIBaseCanvas<TCanvas>` | `framework-cs/upm/com.devian.foundation/Samples~/UIPackage/Runtime/Base/UIBaseCanvas.cs` |
| `UIMessageSystem` | `framework-cs/upm/com.devian.foundation/Samples~/UIPackage/Runtime/Base/UIMessageSystem.cs` |

---

## Related Documents

- [UIBaseCanvas/UIBasePanel/UIBaseContainer](../11-ui-canvas-system/SKILL.md)
