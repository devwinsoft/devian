...
**NDJSON 저장 규약은 `skills/devian/90-tools/11-builder/34-ndjson-storage/SKILL.md`를 따른다.**
...
**pb64 저장(확장자/포장)은 `skills/devian/90-tools/11-builder/35-pb64-storage/SKILL.md`를 따르며, Unity 소비를 위해 `.asset`로 저장한다.**
...
- Related: `skills/devian/90-tools/11-builder/32-json-row-io/SKILL.md` (일반 테이블 포맷)
