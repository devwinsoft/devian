...
- **Shared Runtime**: CommonEffect, MaterialEffect 등 공용 Unity 런타임 컴포넌트
...
| [11-devian-settings](../11-devian-settings/SKILL.md) | CommonSystem 소유 DevianSettings 자산/메뉴 |
| [12-asset-id](../12-asset-id/SKILL.md) | AssetId selector base 및 선택 규약 |
| [13-material-effect-id](../13-material-effect-id/SKILL.md) | MATERIAL_EFFECT_ID 규약 |
...
| [31-string-table](../31-string-table/SKILL.md) | String Table Feature |
| [21-common-effect-manager](../21-common-effect-manager/SKILL.md) | BundlePool 기반 공용 이펙트 시스템 |
| [22-material-effect-controller](../22-material-effect-controller/SKILL.md) | Material[] 기반 공용 머티리얼 효과 |
