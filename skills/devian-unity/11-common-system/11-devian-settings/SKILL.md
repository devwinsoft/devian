...
```
com.devian.domain.common/Runtime/Settings/
└── DevianSettings.cs
```
...
```
com.devian.domain.common/Editor/Settings/
...
- `assetId[COMMON_EFFECT]` = `"Assets/Bundles/CommonEffects"`
...
- common-system 기본값(`COMMON_EFFECT`, `MATERIAL_EFFECT`)은 `DevianSettingsMenu` 내부에서 직접 보수한다
