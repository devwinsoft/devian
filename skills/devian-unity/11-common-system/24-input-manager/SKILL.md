...
- `InputManager` — CompoSingleton, consumer bootstrap/prefab이 부착하는 입력 관리자
...
- BaseBootstrap은 InputManager를 자동 추가하지 않는다.
...
**Editor 파일:** `com.devian.domain.common/Editor/Unity/Input/InputManagerInspector.cs`
...
| 타입 | 경로 |
|------|------|
| InputContext | `com.devian.domain.common/Runtime/Unity/Input/InputContext.cs` |
| InputFrame | `com.devian.domain.common/Runtime/Unity/Input/InputFrame.cs` |
| IInputManager | `com.devian.domain.common/Runtime/Unity/Input/IInputManager.cs` |
| InputButtonMapBuilder | `com.devian.domain.common/Runtime/Unity/Input/InputButtonMapBuilder.cs` |
| InputManager | `com.devian.domain.common/Runtime/Unity/Input/InputManager.cs` |
| InputManagerInspector | `com.devian.domain.common/Editor/Unity/Input/InputManagerInspector.cs` |
