...
- 기본값(`COMMON_EFFECT_ID`, `MATERIAL_EFFECT_ID`)은 `DevianSettingsMenu` 내부에서 직접 보수한다
...
- Base Application: `skills/devian-unity/11-common-system/14-base-application/SKILL.md`
