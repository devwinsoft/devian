...
> **Reference**: `skills/devian-unity/11-common-system/31-table-manager/SKILL.md`
...
- Related: `skills/devian-unity/11-common-system/19-download-manager/SKILL.md` (다운로드 정책)
