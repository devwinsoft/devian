...
> **Networker/SessionHost:** `com.devian.protocol.game`에서 generated code로 제공. `skills/devian/80-tools/11-builder/33-protocol-spec/SKILL.md` 참조.
...
| 주제 | 스킬 경로 |
|------|-----------|
| Game 도메인 허브 | `skills/devian-unity/21-domain-game-system/11-game-domain/SKILL.md` |
...
- Related: `skills/devian-unity/21-domain-game-system/01-policy/SKILL.md`
