...
> **상세 규칙:** `skills/devian/90-tools/11-builder/40-codegen-protocol/SKILL.md` 참조
...
> **샘플 템플릿 상세:** `skills/devian-unity/50-mobile-system/91-game-net-manager/SKILL.md` 참조
...
| 주제 | 스킬 경로 |
|------|-----------|
| Game 도메인 허브 | `skills/devian-unity/40-game-system/11-game-domain/SKILL.md` |
| 프로토콜 코드젠 규칙 | `skills/devian/90-tools/11-builder/40-codegen-protocol/SKILL.md` |
| 프로토콜 생성 구현 | `skills/devian/90-tools/11-builder/44-protocolgen-implementation/SKILL.md` |
| Network 샘플 템플릿 | `skills/devian-unity/50-mobile-system/91-game-net-manager/SKILL.md` |
...
- Related: `skills/devian-unity/40-game-system/01-policy/SKILL.md`
- Related: `skills/devian-examples/03-ssot/SKILL.md`
- Related: `skills/devian/90-tools/11-builder/40-codegen-protocol/SKILL.md`
