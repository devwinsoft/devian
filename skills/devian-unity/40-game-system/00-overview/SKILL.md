...
- [15-game-inventory-system](../15-game-inventory-system/00-overview/SKILL.md) — Inventory System (InventoryManager, InventoryStorage)
- [16-game-storage-manager](../16-game-storage-manager/SKILL.md) — GameStorageManager (게임 저장 파일 직렬화/역직렬화, InventoryStorage 포함 상위 컨테이너)
