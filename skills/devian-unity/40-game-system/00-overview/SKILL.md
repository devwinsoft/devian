...
- [95-game-storage-manager](../../50-mobile-system/95-game-storage-manager/SKILL.md) — GameStorageManager (게임 저장 파일 직렬화/역직렬화, InventoryStorage 포함 상위 컨테이너, moved to 50-mobile-system)
