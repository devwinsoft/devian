...
- AssetId Base: `skills/devian-unity/20-domain-common-system/12-asset-id/SKILL.md`
- MaterialEffect: `skills/devian-unity/20-domain-common-system/23-material-effect-controller/SKILL.md`
