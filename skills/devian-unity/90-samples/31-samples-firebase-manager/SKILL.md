...
- FirebaseManager는 CloudClientSystem 번들 샘플의 단일 asmdef(`Devian.Samples.CloudClientSystem`)에 포함된다.
  - UPM: `framework-cs/upm/com.devian.samples/Samples~/CloudClientSystem/Runtime/Devian.Samples.CloudClientSystem.asmdef`
  - UnityExample mirror: `framework-cs/apps/UnityExample/Packages/com.devian.samples/Samples~/CloudClientSystem/Runtime/Devian.Samples.CloudClientSystem.asmdef`
...
## Locations (mirrored)
- UPM:
  - `framework-cs/upm/com.devian.samples/Samples~/CloudClientSystem/Runtime/Firebase/FirebaseManager.cs`
- UnityExample mirror:
  - `framework-cs/apps/UnityExample/Packages/com.devian.samples/Samples~/CloudClientSystem/Runtime/Firebase/FirebaseManager.cs`
