# 31-samples-mobile-application — MobileApplication (Bootstrap Sample)
...
## Links
- [27-bootstrap](../../10-base-system/27-bootstrap/SKILL.md) — BaseBootstrap 런타임 스펙
- [30-samples-mobile-system](../30-samples-mobile-system/SKILL.md) — MobileSystem 번들 샘플
