# devian-unity/41-game-network — Policy
...
### 3.4 Protocol handlers 구현 정책

`40-game-contents/01-policy/SKILL.md` §3.4.1의 Protocol handlers 구현 정책을 따른다.
...
- `Devian.Core.*`
- `Devian.Templates.*`
- `Devian.Samples.*` (asmdef name으로만 사용)
...
```
{upmConfig.packageDir}/com.devian.samples/Samples~/GameNetwork/
```
...
- [40-game-contents/01-policy](../../40-game-contents/01-policy/SKILL.md) — Protocol handlers 정책 정본
