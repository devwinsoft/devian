...
- **Shared Runtime**: Actor, CommonEffect, MaterialEffect, Pool, Singleton, FSM 등 공용 Unity 런타임 컴포넌트
...
| [devian/20-domain-common/20-common-utils](../../../devian/20-domain-common/20-common-utils/SKILL.md) | CommonUtils |
