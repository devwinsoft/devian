...
| 타입 | 경로 |
|------|------|
| ActorObject | `com.devian.foundation/Samples~/CommonPackage/Runtime/Unity/Actors/ActorObject.cs` |
| ActorController\<TOwner\> | `com.devian.foundation/Samples~/CommonPackage/Runtime/Unity/Actors/ActorController.cs` |
