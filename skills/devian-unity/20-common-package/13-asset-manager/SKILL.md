...
> **Reference**: `skills/devian-unity/20-common-package/31-table-manager/SKILL.md`
...
- Related: `skills/devian-unity/20-common-package/19-bundle-manager/SKILL.md` (다운로드 정책)
