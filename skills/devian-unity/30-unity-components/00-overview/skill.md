# 30-unity-components Overview

## Purpose
Unity 런타임 컴포넌트(비-UI)의 스킬 인덱스와 진입점이다.
이 폴더는 "Unity 컴포넌트" 범위만 다루며, UI는 40-ui-components로 분리되어 있다.
...
### Excludes
- UI 관련 컴포넌트 / Canvas / UI 입력 등 → `skills/devian-unity/40-ui-components/`
- 게임/도메인 기능(프로젝트별 구성)

## Where to start
- Index: `skills/devian-unity/30-unity-components/skill.md`
- UI: `skills/devian-unity/40-ui-components/skill.md`
