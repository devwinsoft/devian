...
도메인 UPM 패키지(`com.devian.domain.*`)의 **생성/구조/규칙 SSOT** 인덱스이다.
...
| ID | 문서 | 설명 |
|----|------|------|
| template | `com.devian.domain.template/SKILL.md` | 도메인 패키지 공통 템플릿 (레이아웃, asmdef, TableID 등) |
| common | `com.devian.domain.common/SKILL.md` | `com.devian.domain.common` 패키지 규약 (Features, Complex PropertyDrawer 등) |
