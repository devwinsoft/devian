...
> **상세 API**: `skills/devian/10-module/03-ssot/SKILL.md` (Foundation Package SSOT) 참조
...
- Related: `skills/devian/10-module/03-ssot/SKILL.md` (Foundation Package SSOT, TableID 베이스 클래스)
