...
`AbilityEquip` 필드 (구현: [12-game-ability](../../../21-game-package/12-game-ability/SKILL.md)):
...
`AbilityCard` 필드 (구현: [12-game-ability](../../../21-game-package/12-game-ability/SKILL.md)):
...
`AbilityUnitHero` 필드 (구현: [12-game-ability](../../../21-game-package/12-game-ability/SKILL.md)):
