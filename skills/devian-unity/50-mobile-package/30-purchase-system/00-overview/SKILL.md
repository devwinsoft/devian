...
Purchase(유료) 경로의 실제 지급 실행은 `reward_group_id`를 RewardManager(49-reward-system)에 전달해 위임한다.
...
| [10-purchase-manager](../10-purchase-manager/SKILL.md) | PurchaseManager(구매) 샘플 |
