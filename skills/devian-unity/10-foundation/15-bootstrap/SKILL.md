...
- DevianSettings: `skills/devian-unity/10-foundation/13-devian-settings/SKILL.md`
- SceneTransManager: `skills/devian-unity/10-foundation/16-scene-trans-manager/SKILL.md`
- Singleton: `skills/devian-unity/10-foundation/14-singleton/SKILL.md`
