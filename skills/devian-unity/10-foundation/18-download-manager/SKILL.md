...
- Related: `skills/devian-unity/10-foundation/14-singleton/SKILL.md` (ResSingleton)
- Related: `skills/devian-unity/10-foundation/17-asset-manager/SKILL.md` (AssetManager)
