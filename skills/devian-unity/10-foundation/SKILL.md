...
| 21 | AssetId | 폴더 스캔 기반 Asset ID 선택 UI (Select + 검색) 공통 패턴 | `12-asset-id/SKILL.md` |
| 22 | EffectManager | BundlePool 기반 이펙트 스폰/디스폰 + Runner 확장 | `29-common-effect-manager/SKILL.md` |
| 23 | DevianSettings | config.json → Assets/Settings JSON → Settings.asset 일관 파이프라인 | `14-devian-settings/SKILL.md` |
