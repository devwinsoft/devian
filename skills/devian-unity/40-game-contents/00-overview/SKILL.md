# devian-unity/40-game-contents — Overview

Status: ACTIVE
AppliesTo: v10

Game Contents는 **Devian Samples**(`com.devian.samples`)에 포함된 Unity Sample이다.
...
|----------|-------------|
| [01-policy](../01-policy/SKILL.md) | Game Contents 그룹 정책 (Templates 규칙) |
...
- [22-inventory-system](../../50-mobile-system/22-inventory-system/00-overview/SKILL.md) — Inventory System (InventoryManager, InventoryStorage, moved to 50-mobile-system)
- [11-game-net-manager](../../41-game-network/11-game-net-manager/SKILL.md) — Unity Network 샘플 (GameNetManager / Game2CStub, moved to 41-game-network)
