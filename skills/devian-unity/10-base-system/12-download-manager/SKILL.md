...
- Related: `skills/devian-unity/10-base-system/31-singleton/SKILL.md` (ResSingleton)
- Related: `skills/devian-unity/10-base-system/10-asset-manager/SKILL.md` (AssetManager)
