...
> **Reference**: `skills/devian-common/14-feature-string-table/SKILL.md`, `skills/devian-unity/10-base-system/14-table-manager/SKILL.md`
...
- Related: `skills/devian-unity/10-base-system/12-download-manager/SKILL.md` (다운로드 정책)
