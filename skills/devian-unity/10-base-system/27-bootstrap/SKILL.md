...
프리팹 생성 규칙은 [31-samples-mobile-application](../../90-samples/31-samples-mobile-application/SKILL.md)에서 다룬다.
...
- DevianSettings: `skills/devian-unity/10-base-system/23-devian-settings/SKILL.md`
- SceneTransManager: `skills/devian-unity/10-base-system/15-scene-trans-manager/SKILL.md`
