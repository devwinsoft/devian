...
> **NDJSON 저장 규약:** 내용은 NDJSON이며 확장자는 `.json` 고정. 정본: `skills/devian-data/34-ndjson-storage/SKILL.md`
> **pb64 저장 규약:** Unity TextAsset `.asset` 형식. 정본: `skills/devian-data/35-pb64-storage/SKILL.md`
...
- 입력 규칙: `skills/devian-data/30-table-authoring-rules/SKILL.md`
- 동작 정본: 런타임/제너레이터 코드
