...
- String Table: `skills/devian-common/14-feature-string-table/SKILL.md` → `.../string/ndjson/...`
...
- Consumer: `skills/devian-common/14-feature-string-table/SKILL.md` (String Table)
