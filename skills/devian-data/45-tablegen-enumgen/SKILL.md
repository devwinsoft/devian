...
- Table Authoring Rules: `skills/devian-data/30-table-authoring-rules/SKILL.md`
- TableGen Implementation: `skills/devian-data/42-tablegen-implementation/SKILL.md`
