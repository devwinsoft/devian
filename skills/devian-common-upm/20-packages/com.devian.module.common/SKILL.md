...
com.devian.unity (Unity adapters)
       ↑
com.devian.module.common (이 패키지 - core + unity 의존)
```
...
### Runtime asmdef (파일명: `Devian.Module.Common.asmdef`)
...
### Editor asmdef (파일명: `Devian.Module.Common.Editor.asmdef`)

```json
{
  "name": "Devian.Module.Common.Editor",
  "rootNamespace": "Devian.Module.Common.Editor",
  "references": [
...
- Related: `skills/devian-common-feature/11-feature-variant/SKILL.md`
