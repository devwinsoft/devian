...
- String Table pb64 payload: `skills/devian-common/14-string-table/SKILL.md`의 StringChunk 규약
...
> **Reference:** `skills/devian-common/14-string-table/SKILL.md`의 "pb64 Encoding/Decoding 규칙" 섹션
