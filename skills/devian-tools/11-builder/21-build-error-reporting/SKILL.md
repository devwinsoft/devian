...
- `skills/devian-tools/11-builder/21-build-error-reporting/SKILL.md`

### 빌드 관련

- `skills/devian-tools/11-builder/20-build-domain/SKILL.md`
- `skills/devian/10-module/03-ssot/SKILL.md`

### 입력 규약 (연결 후보)

- `skills/devian-unity/06-domain-packages/com.devian.domain.template/SKILL.md` — 도메인 패키지 생성 규칙
- `skills/devian-unity/90-samples/01-policy/SKILL.md`
