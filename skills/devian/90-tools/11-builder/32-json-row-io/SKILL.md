...
- **NDJSON 저장 규약**: `skills/devian/90-tools/11-builder/34-ndjson-storage/SKILL.md` 참조
- **pb64 저장 규약**: `skills/devian/90-tools/11-builder/35-pb64-storage/SKILL.md` 참조
...
- DFF 문법은 `skills/devian/90-tools/11-builder/31-class-cell-format/SKILL.md`를 따른다.
...
- NDJSON 저장: `skills/devian/90-tools/11-builder/34-ndjson-storage/SKILL.md`
- pb64 저장: `skills/devian/90-tools/11-builder/35-pb64-storage/SKILL.md`
- DFF 규약: `skills/devian/90-tools/11-builder/31-class-cell-format/SKILL.md`
- 동작 정본: 런타임/제너레이터 코드
