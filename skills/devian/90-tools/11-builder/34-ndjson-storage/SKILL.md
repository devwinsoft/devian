...
- String Table: `skills/devian-unity/11-common-system/31-string-table/SKILL.md` → `.../string/ndjson/...`
- 일반 Table: `skills/devian/90-tools/11-builder/32-json-row-io/SKILL.md` → `.../ndjson/...`
...
- Consumer: `skills/devian/90-tools/11-builder/32-json-row-io/SKILL.md` (일반 Table)
- Consumer: `skills/devian-unity/11-common-system/31-string-table/SKILL.md` (String Table)
