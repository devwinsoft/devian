...
> **정책 문서:** [skills/devian/90-tools/11-builder/20-build-domain](../11-builder/20-build-domain/SKILL.md)

### 빌드 에러 리포팅

빌드 실패 시 에러 출력 규격 및 로그 파일 규칙:

> **정책 문서:** [skills/devian/90-tools/11-builder/21-build-error-reporting](../11-builder/21-build-error-reporting/SKILL.md)
