...
TS GameServer의 기본 codec은 Protobuf이다(인자 미주입).  
...
| GameServer | 조립 + 핸들러 등록 | 비즈니스 로직 확장 |

---

## 예제 앱

위치: `framework-ts/apps/GameServer/`
...
- **정책 정본:** `skills/devian/10-module/03-ssot/SKILL.md`
