...
- `skills/devian/19-build-error-reporting/SKILL.md`

### 빌드 관련

- `skills/devian/18-build-domain/SKILL.md`
- `skills/devian/03-ssot/SKILL.md`

### 입력 규약 (연결 후보)

- `skills/devian-upm/20-packages/com.devian.domain.template/SKILL.md` — 도메인 패키지 생성 규칙
