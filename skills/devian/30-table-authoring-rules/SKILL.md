...
상세 규칙은 `skills/devian/45-tablegen-enumgen/SKILL.md` 참조.
...
참조 타입 셀 값의 텍스트 규약(DFF)은 `skills/devian/31-class-cell-format/SKILL.md`를 따른다.
...
- Enum Generation: `skills/devian/45-tablegen-enumgen/SKILL.md`
- 동작 정본: 런타임/제너레이터 코드
