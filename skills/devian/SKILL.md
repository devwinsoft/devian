...
| 플레이스홀더 | 설명 | 예시 |
|-------------|------|------|
| `{buildInputJson}` | 빌드 입력 JSON | `input/build_input.json` |
| `{projectConfigJson}` | 프로젝트 설정 JSON | `input/build_config.json` |
...
| **Tools** | [devian/90-tools/03-ssot](./90-tools/03-ssot/SKILL.md) | 빌드 파이프라인, Phase, Validate, tempDir |
| **Builder** | [devian/90-tools/11-builder/03-ssot](./90-tools/11-builder/03-ssot/SKILL.md) | tableConfig, Tables, NDJSON, pb64, Protocol Spec, Opcode/Tag, Protocol UPM |
...
| 목적 | 문서 |
|------|------|
| 빌드 실행하기 | [skills/devian/90-tools/11-builder/20-build-domain](./90-tools/11-builder/20-build-domain/SKILL.md) |
| 빌드 에러 이해하기 | [skills/devian/90-tools/11-builder/21-build-error-reporting](./90-tools/11-builder/21-build-error-reporting/SKILL.md) |
| 아카이브/배포하기 | [skills/devian/90-tools/90-project-archive](./90-tools/90-project-archive/SKILL.md) |
| 테이블 작성하기 | [skills/devian/90-tools/11-builder/30-table-authoring-rules](./90-tools/11-builder/30-table-authoring-rules/SKILL.md) |
| NDJSON/Row IO 이해하기 | [skills/devian/90-tools/11-builder/32-json-row-io](./90-tools/11-builder/32-json-row-io/SKILL.md) |
| ContractGen 구현 보기 | [skills/devian/90-tools/11-builder/43-contractgen-implementation](./90-tools/11-builder/43-contractgen-implementation/SKILL.md) |
| 프로토콜 코드젠 보기 | [skills/devian/90-tools/11-builder/40-codegen-protocol](./90-tools/11-builder/40-codegen-protocol/SKILL.md) |
...
| **devian/90-tools** | [00-overview](./90-tools/00-overview/SKILL.md) | [01-policy](./90-tools/01-policy/SKILL.md) | [03-ssot](./90-tools/03-ssot/SKILL.md) | 아카이브, CLI 도구 |
| **devian/90-tools/11-builder** | [00-overview](./90-tools/11-builder/00-overview/SKILL.md) | [01-policy](./90-tools/11-builder/01-policy/SKILL.md) | [03-ssot](./90-tools/11-builder/03-ssot/SKILL.md) | 빌드, 테이블, 계약, NDJSON, PB64, 프로토콜 코드젠, 에러 리포팅 |
