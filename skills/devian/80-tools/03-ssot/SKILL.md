...
자세한 규칙: [skills/devian/05-workspace](../../05-workspace/SKILL.md)
...
| 설정 파일 | tempDir 권장값 |
|----------|---------------|
| `{buildInputJson}` (예: `input/build_input.json`) | `"temp"` |
| 대체 입력 (예시) | `"temp_alt"` |
...
> **정책 문서:** [skills/devian/80-tools/11-builder/20-build-pipeline](../11-builder/20-build-pipeline/SKILL.md)

### 빌드 에러 리포팅

빌드 실패 시 에러 출력 규격 및 로그 파일 규칙:

> **정책 문서:** [skills/devian/80-tools/11-builder/21-build-error-reporting](../11-builder/21-build-error-reporting/SKILL.md)
...
- [Workspace](../../05-workspace/SKILL.md)
