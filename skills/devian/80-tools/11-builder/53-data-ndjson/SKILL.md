...
- String Table: `skills/devian-unity/20-domain-common-system/30-string-table/SKILL.md` → `.../string/ndjson/...`
...
- Consumer: `skills/devian-unity/20-domain-common-system/30-string-table/SKILL.md` (String Table)
