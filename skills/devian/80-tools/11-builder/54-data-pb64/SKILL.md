...
- String Table pb64 payload: `skills/devian-unity/20-common-package/30-string-table/SKILL.md`의 StringChunk 규약
...
> **Reference:** `skills/devian-unity/20-common-package/30-string-table/SKILL.md`의 "pb64 Encoding/Decoding 규칙" 섹션
...
- String Table: `skills/devian-unity/20-common-package/30-string-table/SKILL.md`
