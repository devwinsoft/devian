...
→ [skills/devian-core/03-ssot/SKILL.md](./devian-core/03-ssot/SKILL.md) — 모든 정책/경로/규칙의 정본 (SSOT)
...
| **devian-data** | [00-overview](./devian-data/00-overview/SKILL.md) | [01-policy](./devian-data/01-policy/SKILL.md) | [03-ssot](./devian-data/03-ssot/SKILL.md) | 테이블, 계약, NDJSON, PB64, String Table |
