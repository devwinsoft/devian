...
- Related: `skills/devian-upm/30-unity-components/01-singleton/SKILL.md` (ResSingleton)
- Related: `skills/devian-upm/30-unity-components/10-asset-manager/SKILL.md` (AssetManager)
