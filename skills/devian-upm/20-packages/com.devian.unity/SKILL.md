...
> **도메인 패키지 생성 규칙 상세**: `skills/devian-upm/20-packages/com.devian.domain.template/SKILL.md` 참조
...
> **전용 스킬 문서 참조:** `skills/devian-upm/30-unity-components/10-asset-manager/SKILL.md`
...
- Related: `skills/devian-upm/30-unity-components/11-network-client-behaviour/SKILL.md`
