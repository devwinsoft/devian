...
### Package Metadata
- `skills/devian-upm/03-package-metadata/SKILL.md`

### 패키지별 문서
- `skills/devian-upm/02-upm-bundles/SKILL.md`
- `skills/devian-upm/20-packages/com.devian.unity/SKILL.md`
- `skills/devian-upm/20-packages/com.devian.domain.common/SKILL.md`

### Unity Components
- AssetManager: `skills/devian-upm/30-unity-components/10-asset-manager/SKILL.md`
...
- UPM Samples 정책: `skills/devian-upm-samples/01-samples-authoring-guide/SKILL.md`
