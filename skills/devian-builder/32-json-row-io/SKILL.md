...
- **NDJSON 저장 규약**: `skills/devian-builder/34-ndjson-storage/SKILL.md` 참조
- **pb64 저장 규약**: `skills/devian-builder/35-pb64-storage/SKILL.md` 참조
...
- DFF 문법은 `skills/devian-builder/31-class-cell-format/SKILL.md`를 따른다.
