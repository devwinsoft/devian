...
상세 규칙은 `skills/devian-builder/45-tablegen-enumgen/SKILL.md` 참조.
...
참조 타입 셀 값의 텍스트 규약(DFF)은 `skills/devian-builder/31-class-cell-format/SKILL.md`를 따른다.
...
> **NDJSON 저장 규약:** 파일 확장자는 `.json`이지만, `ndjson/` 폴더의 파일 내용은 NDJSON(라인 단위 JSON)이다. 정본: `skills/devian-builder/34-ndjson-storage/SKILL.md`
> **pb64 저장 규약:** 정본: `skills/devian-builder/35-pb64-storage/SKILL.md`
...
- DFF 규약: `skills/devian-builder/31-class-cell-format/SKILL.md`
- Enum Generation: `skills/devian-builder/45-tablegen-enumgen/SKILL.md`
- 동작 정본: 런타임/제너레이터 코드
