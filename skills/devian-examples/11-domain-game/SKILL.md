...
| 유형 | 경로 | 설명 |
|------|------|------|
| Tables | `devian/input/Domains/Game/TestTable.xlsx` | 테이블 예제 |
| Contracts | `devian/input/Domains/Game/TestContract.json` | 컨트랙트 예제 |
...
```
input/Domains/Game/*.xlsx
input/Domains/Game/*.json
        ↓
   [build.js]
        ↓
  staging (tempDir)
...
| 테이블 작성 규칙 | `skills/devian-tools/11-builder/30-table-authoring-rules/SKILL.md` |
| 테이블 생성 구현 | `skills/devian-tools/11-builder/42-tablegen-implementation/SKILL.md` |
| 컨트랙트 생성 구현 | `skills/devian-tools/11-builder/43-contractgen-implementation/SKILL.md` |
