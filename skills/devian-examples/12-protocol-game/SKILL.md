...
> **샘플 템플릿 상세:** `skills/devian-unity/40-game-system/21-game-net-manager/SKILL.md` 참조
...
| Network 샘플 템플릿 | `skills/devian-unity/40-game-system/21-game-net-manager/SKILL.md` |
