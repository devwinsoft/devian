...
> **상세 규칙:** `skills/devian/20-codegen-protocol/SKILL.md` 참조
...
> **샘플 템플릿 상세:** `skills/devian-upm-samples/10-samples-network/SKILL.md` 참조
...
| 주제 | 스킬 경로 |
|------|-----------|
| 프로토콜 코드젠 규칙 | `skills/devian/20-codegen-protocol/SKILL.md` |
| 프로토콜 생성 구현 | `skills/devian/62-protocolgen-implementation/SKILL.md` |
| Network 샘플 템플릿 | `skills/devian-upm-samples/10-samples-network/SKILL.md` |
| WebSocket 클라이언트 | `skills/devian/12-network-ws-client/SKILL.md` |
| 네트워크 서버 | `skills/devian/72-network-server/SKILL.md` |
...
- Related: `skills/devian/20-codegen-protocol/SKILL.md`
