...
namespace Devian
{
    ...
    /// CompoSingleton — bootstrap prefab/scene object에 미리 부착해야 한다.
    /// framework script code가 런타임 AddComponent로 생성하지 않는다.
    /// IInputManager는 OnEnable/OnDisable에서 별도 Register.
