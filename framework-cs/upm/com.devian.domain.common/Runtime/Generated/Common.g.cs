...
namespace Devian.Domain.Common
{
    ...
    public enum CommonErrorType : int
    {
        ...
        PURCHASE_ADJUSTMENTS_INVALID_ARGUMENT = 80,
        PURCHASE_CLIENT_GRANT_PURCHASE_ID_EMPTY = 81,
        PURCHASE_ENTITLEMENTS_CALL_FAILED = 82,
        PURCHASE_FUNCTION_CALL_FAILED = 83,
        PURCHASE_FUNCTION_RESPONSE_INVALID = 84,
        PURCHASE_INIT_FAILED = 85,
        PURCHASE_INIT_REQUIRED = 86,
        PURCHASE_INTERNAL_PRODUCT_ID_EMPTY = 87,
        PURCHASE_INTERRUPTED_SNAPSHOT_KIND_INVALID = 88,
        PURCHASE_INTERRUPTED_SNAPSHOT_PRODUCT_ID_MISSING = 89,
        PURCHASE_INTERRUPTED_STORAGE_UNAVAILABLE = 90,
        PURCHASE_NETWORK_UNAVAILABLE = 91,
        PURCHASE_PRODUCT_FETCH_FAILED = 92,
        PURCHASE_PRODUCT_NOT_FOUND = 93,
        PURCHASE_PURCHASE_IN_PROGRESS = 94,
        PURCHASE_PURCHASE_REQUEST_FAILED = 95,
        PURCHASE_RECENT_CALL_FAILED = 96,
        PURCHASE_RECENT_NOT_FOUND = 97,
        PURCHASE_REFUND_APPLY_FAILED = 98,
        PURCHASE_RENTAL_LATEST_CALL_FAILED = 99,
        PURCHASE_RENTAL_LATEST_NOT_FOUND = 100,
        PURCHASE_RESTORE_FAILED = 101,
        PURCHASE_SEASON_PASS_ALREADY_OWNED = 102,
        PURCHASE_STORE_CONFIRM_ACK_CALL_FAILED = 103,
        PURCHASE_STORE_FAILED = 104,
        PURCHASE_STORE_NOT_SET = 105,
        PURCHASE_UNAUTHENTICATED = 106,
        PURCHASE_UNSUPPORTED_PLATFORM = 107,
        PURCHASE_VERIFY_CALL_FAILED = 108,
        PURCHASE_VERIFY_FAILED_PRECONDITION = 109,
        PURCHASE_VERIFY_INVALID_ARGUMENT = 110,
        PURCHASE_VERIFY_REJECTED_UNKNOWN = 111,
        SAVEDATA_PAYLOAD_PARSE_FAILED = 112,
        SAVEDATA_SYNC_CANCELLED = 113,
        SAVEDATA_SYNC_LOAD_LOCAL_FAILED = 114,
        SAVEDATA_SYNC_REQUIRED = 115,
        SAVEDATA_SYNC_RESOLVE_FAILED = 116,
        SAVEDATA_SYNC_SAVE_CLOUD_FAILED = 117,
        SAVEDATA_SYNC_SAVE_LOCAL_FAILED = 118,
    }
