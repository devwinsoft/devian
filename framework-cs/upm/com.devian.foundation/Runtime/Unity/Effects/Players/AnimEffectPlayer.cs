...
namespace Devian
{
    ...
    public sealed class AnimEffectPlayer : MonoBehaviour, ICommonEffectPlayer
    {
        [Tooltip("Global speed multiplier forwarded to AnimSequencePlayer.PlayDefault().")]
        public float playSpeed = 1f;

        private CommonEffectObject _owner;
        ...
        public void _OnEffectAwake(CommonEffectObject owner)
        {
            _owner = owner;
        ...
        {
            // Sprite sorting already handled by CommonEffectObject.SetSortingOrder
        }
