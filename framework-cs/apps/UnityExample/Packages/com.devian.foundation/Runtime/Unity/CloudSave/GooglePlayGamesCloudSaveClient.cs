...
namespace Devian
{
    ...
    /// </summary>
    public sealed class GooglePlayGamesCloudSaveClient : ICloudSaveClient
    {
        ...
        public GooglePlayGamesCloudSaveClient()
        {
#if UNITY_ANDROID && !UNITY_EDITOR
            try
            {
            ...
            {
                Debug.LogWarning($"[GooglePlayGamesCloudSaveClient] init failed: {e.Message}");
                _isAvailable = false;
            }
#else
            _isAvailable = false;
