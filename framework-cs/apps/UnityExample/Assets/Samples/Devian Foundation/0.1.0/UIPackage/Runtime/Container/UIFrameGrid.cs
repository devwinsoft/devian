...
namespace Devian
{
    ...
    /// IScrollSection 구현. Container가 row bind/unbind를 직접 호출한다.
    ...
    public class UIFrameGrid : UIContainerFrameBase, IScrollSection
    {
        ...
        public void BindRow(in ScrollRowLayout rowLayout)
        {
            ...
            var rowCells = new List<UIFrameGridCell>(cellsInRow);

            for (int c = 0; c < cellsInRow; c++)
            {
                int cellIndex = startIndex + c;
                var cell = BundlePool.Spawn<UIFrameGridCell>(
        ...
        private readonly Dictionary<int, List<UIFrameGridCell>> _activeRows = new();
        private static readonly Vector2 TopLeft = new Vector2(0f, 1f);
        private ScrollSectionLayout _sectionLayout;
    }
}
