...
namespace Devian
{
    ...
    public abstract class UIBasePagePopup : UIBasePanel
    {
        ...
        public bool isCurrentPopup => ownerCanvas != null && ownerCanvas.currentPopup == this;
        ...
        public new void Hide()
        {
            ...
            ownerCanvas.TryHidePopup(this, UIPagePopupCloseReason.Normal, animated: true);
        }
        ...
        protected sealed override void onInitFromCanvas(MonoBehaviour canvasOwner)
        {
            ...
            {
                Debug.LogError(
                    $"[{GetType().Name}] Popup owner must be UIBasePageCanvas. " +
        ...
        internal bool _ValidateTransitionSetup(out string reason)
        {
            ...
            {
                reason = $"Popup page '{name}' is missing UITransitionPlayer.";
                return false;
            }
    ...
    public abstract class UIBasePagePopup<TCanvas> : UIBasePagePopup
        where TCanvas : UIBasePageCanvas
    {
        ...
        protected sealed override void onInit(UIBasePageCanvas canvas)
        {
            ...
            {
                Debug.LogError(
                    $"[{GetType().Name}] Popup canvas must be {typeof(TCanvas).Name}. " +
