...
namespace Devian
{
    /// <summary>Selector for StringTable GAME_TEXT_ID</summary>
    public class Game_GAME_TEXT_ID_Selector : BaseEditorID_Selector
    {
        protected override string GetDisplayTypeName() => "GAME_TEXT";
        ...
        public override void Reload()
        {
            ...
            var textAssets = AssetManager.FindAssets<TextAsset>("GAME_TEXT");
    ...
    /// <summary>PropertyDrawer for GAME_TEXT_ID</summary>
    [CustomPropertyDrawer(typeof(GAME_TEXT_ID))]
    public class Game_GAME_TEXT_ID_Drawer : BaseEditorID_Drawer<Game_GAME_TEXT_ID_Selector>
    {
        protected override Game_GAME_TEXT_ID_Selector GetSelector()
        {
            var w = ScriptableObject.CreateInstance<Game_GAME_TEXT_ID_Selector>();
            w.titleContent = new GUIContent("Select GAME_TEXT");
            w.ShowUtility();
            return w;
        }
    }
