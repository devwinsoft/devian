...
namespace Devian
{
    ...
    public sealed class CloudSaveManager : CompoSingleton<CloudSaveManager>
    {
        ...
        private CloudSaveClientApple _client;
        ...
        public void Configure(
            CloudSaveClientApple client = null,
        ...
        private static CloudSaveClientApple _createDefaultClient()
        {
            ...
            return new CloudSaveClientGoogle();
#else
        ...
        private static void _tryActivateGpgsSavedGames()
        {
            ...
            try
            {
                ...
                {
                    // v2: Activate() only (no Builder / InitializeInstance).
                    platformType.GetMethod("Activate", BindingFlags.Public | BindingFlags.Static)
                        ?.Invoke(null, null);
                    return;
                }

                // v1 fallback: Builder → EnableSavedGames → InitializeInstance → Activate.
