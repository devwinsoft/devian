// UIVirtualLookPad.cs
// UGUI virtual pad (joystick) for mobile — Look input only.
...
// - If VirtualGamepadDriver exists, feeds CurrentValue to VirtualGamepadDriver.SetLook each frame.
...
namespace Devian
{
    ...
    public sealed class UIVirtualLookPad : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        ...
        private void MovePadVisualCenterToScreen(Vector2 screenPos)
        {
            ...
            var pivotOffsetWorld = pivotWorld - centerWorld;
