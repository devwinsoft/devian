...
namespace Devian.Domain.Common
{
    ...
    public enum CommonErrorType : int
    {
        ...
        PURCHASE_RENTAL_LATEST_CALL_FAILED = 82,
        PURCHASE_RENTAL_LATEST_NOT_FOUND = 83,
        PURCHASE_RESTORE_FAILED = 84,
        PURCHASE_SEASON_PASS_ALREADY_OWNED = 85,
        PURCHASE_STORE_FAILED = 86,
        PURCHASE_STORE_NOT_SET = 87,
        PURCHASE_UNAUTHENTICATED = 88,
        PURCHASE_UNSUPPORTED_PLATFORM = 89,
        PURCHASE_VERIFY_CALL_FAILED = 90,
        PURCHASE_VERIFY_FAILED_PRECONDITION = 91,
        PURCHASE_VERIFY_INVALID_ARGUMENT = 92,
        PURCHASE_VERIFY_REJECTED_UNKNOWN = 93,
        SAVEDATA_PAYLOAD_PARSE_FAILED = 94,
    }
