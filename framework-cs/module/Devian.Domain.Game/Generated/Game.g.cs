...
namespace Devian.Domain.Game
{
    ...
    public enum GAME_ERROR_TYPE : int
    {
        ...
        INVENTORY_CARD_LEVELUP_COUNT_INSUFFICIENT = 49,
        INVENTORY_DELTA_AMOUNT_NEGATIVE = 50,
        INVENTORY_DELTA_ID_EMPTY = 51,
        INVENTORY_DELTA_TYPE_INVALID = 52,
        INVENTORY_DELTAS_NULL = 53,
        INVENTORY_EQUIP_LEVELUP_MATERIAL_INSUFFICIENT = 54,
        INVENTORY_HERO_LEVELUP_COUNT_INSUFFICIENT = 55,
        INVENTORY_ITEM_LEVELUP_CURRENCY_INSUFFICIENT = 56,
        INVENTORY_REFUND_INSUFFICIENT = 57,
        LEADERBOARD_MESSAGE_NOT_FOUND = 58,
        LEADERBOARD_MESSAGE_SAVE_TYPE_INVALID = 59,
        LEADERBOARD_NOT_FOUND = 60,
        LEADERBOARD_PLATFORM_ID_MISSING = 61,
        LEADERBOARD_SEASON_NOT_ACTIVE = 62,
        LEADERBOARD_SEASON_NOT_FOUND = 63,
        LEADERBOARD_SEASON_TIME_INVALID = 64,
        LEADERBOARD_SERVER_TIME_UNAVAILABLE = 65,
        LOCALSAVE_CANCELLED = 66,
        LOCALSAVE_CHECKSUM = 67,
        LOCALSAVE_FILENAME_EMPTY = 68,
        LOCALSAVE_FILENAME_INVALID = 69,
        LOCALSAVE_KEYIV = 70,
        LOCALSAVE_NOT_FOUND = 71,
        LOCALSAVE_PATH_EMPTY = 72,
        LOCALSAVE_READ = 73,
        LOCALSAVE_SLOT_EMPTY = 74,
        LOCALSAVE_SLOT_MISSING = 75,
        LOCALSAVE_WRITE = 76,
        LOGIN_ANONYMOUS_EXCEPTION = 77,
        LOGIN_ANONYMOUS_FAILED = 78,
        LOGIN_APPLE_EXCEPTION = 79,
        LOGIN_APPLE_LINK_FAILED = 80,
        LOGIN_APPLE_MISSING_TOKEN = 81,
        LOGIN_APPLE_SIGNIN_FAILED = 82,
        LOGIN_CREDENTIAL_UNSUPPORTED = 83,
        LOGIN_FIREBASE_DEPENDENCY = 84,
        LOGIN_GOOGLE_EXCEPTION = 85,
        LOGIN_GOOGLE_LINK_FAILED = 86,
        LOGIN_GOOGLE_MISSING_AUTH_CODE = 87,
        LOGIN_GOOGLE_SIGNIN_FAILED = 88,
        LOGIN_GPGS_AUTH_FAILED = 89,
        LOGIN_GPGS_EXCEPTION = 90,
        LOGIN_GPGS_NO_AUTH_CODE = 91,
        LOGIN_GPGS_NO_AUTHENTICATE = 92,
        LOGIN_GPGS_NO_SERVER_ACCESS = 93,
        LOGIN_GPGS_NOT_FOUND = 94,
        LOGIN_GPGS_NOT_INITIALIZED = 95,
        LOGIN_SYNC_CANCELLED = 96,
        LOGIN_SYNC_LOAD_CLOUD_FAILED = 97,
        LOGIN_SYNC_LOAD_LOCAL_FAILED = 98,
        LOGIN_SYNC_RESOLVE_FAILED = 99,
        LOGIN_SYNC_SAVE_CLOUD_FAILED = 100,
        LOGIN_SYNC_SAVE_LOCAL_FAILED = 101,
        LOGIN_SYNC_SLOT_LIST_FAILED = 102,
        LOGIN_UNSUPPORTED = 103,
        MISSION_ALREADY_CLAIMED = 104,
        MISSION_NOT_CLAIMABLE = 105,
        MISSION_NOT_FOUND = 106,
        MISSION_RUNTIME_MISSING = 107,
        MISSION_RUNTIME_STALE = 108,
        PURCHASE_ADJUSTMENTS_CALL_FAILED = 109,
        PURCHASE_ADJUSTMENTS_INVALID_ARGUMENT = 110,
        PURCHASE_CLIENT_GRANT_PURCHASE_ID_EMPTY = 111,
        PURCHASE_ENTITLEMENTS_CALL_FAILED = 112,
        PURCHASE_FETCH_FAILED = 113,
        PURCHASE_FUNCTION_CALL_FAILED = 114,
        PURCHASE_FUNCTION_RESPONSE_INVALID = 115,
        PURCHASE_INIT_FAILED = 116,
        PURCHASE_INIT_REQUIRED = 117,
        PURCHASE_INTERNAL_PRODUCT_ID_EMPTY = 118,
        PURCHASE_INTERRUPTED_SNAPSHOT_KIND_INVALID = 119,
        PURCHASE_INTERRUPTED_SNAPSHOT_PRODUCT_ID_MISSING = 120,
        PURCHASE_INTERRUPTED_STORAGE_UNAVAILABLE = 121,
        PURCHASE_NETWORK_UNAVAILABLE = 122,
        PURCHASE_NOT_FOUND = 123,
        PURCHASE_PURCHASE_IN_PROGRESS = 124,
        PURCHASE_PURCHASE_REQUEST_FAILED = 125,
        PURCHASE_RECENT_CALL_FAILED = 126,
        PURCHASE_RECENT_NOT_FOUND = 127,
        PURCHASE_REFUND_APPLY_FAILED = 128,
        PURCHASE_RENTAL_LATEST_CALL_FAILED = 129,
        PURCHASE_RENTAL_LATEST_NOT_FOUND = 130,
        PURCHASE_RESTORE_FAILED = 131,
        PURCHASE_SEASON_END_SOON_BLOCKED = 132,
        PURCHASE_SEASON_PASS_ALREADY_OWNED = 133,
        PURCHASE_STORE_CONFIRM_ACK_CALL_FAILED = 134,
        PURCHASE_STORE_FAILED = 135,
        PURCHASE_STORE_NOT_SET = 136,
        PURCHASE_UNAUTHENTICATED = 137,
        PURCHASE_UNSUPPORTED_PLATFORM = 138,
        PURCHASE_VERIFY_CALL_FAILED = 139,
        PURCHASE_VERIFY_FAILED_PRECONDITION = 140,
        PURCHASE_VERIFY_INVALID_ARGUMENT = 141,
        PURCHASE_VERIFY_REJECTED_UNKNOWN = 142,
        PUSH_DUPLICATE_NOTIFICATION = 143,
        PUSH_LOCAL_NOT_FOUND = 144,
        PUSH_NOT_INITIALIZED = 145,
        PUSH_NOTIFICATION_CANCEL_FAILED = 146,
        PUSH_NOTIFICATION_SCHEDULE_FAILED = 147,
        PUSH_PERMISSION_DENIED = 148,
        PUSH_TABLE_NOT_LOADED = 149,
        PUSH_TEST_BLOCKED = 150,
        PUSH_TOKEN_FAILED = 151,
        PUSH_TOPIC_SUBSCRIBE_FAILED = 152,
        PUSH_TOPIC_UNSUBSCRIBE_FAILED = 153,
        PUSH_UNSUPPORTED_PLATFORM = 154,
        RECOVERY_DECODE_FAILED = 155,
        RECOVERY_HMAC_FAILED = 156,
        RECOVERY_UNSUPPORTED_VERSION = 157,
        SAVEDATA_PAYLOAD_PARSE_FAILED = 158,
        SAVEDATA_SYNC_CANCELLED = 159,
        SAVEDATA_SYNC_LOAD_LOCAL_FAILED = 160,
        SAVEDATA_SYNC_REQUIRED = 161,
        SAVEDATA_SYNC_RESOLVE_FAILED = 162,
        SAVEDATA_SYNC_SAVE_CLOUD_FAILED = 163,
        SAVEDATA_SYNC_SAVE_LOCAL_FAILED = 164,
        SHOP_ADS_NOT_AVAILABLE = 165,
        SHOP_ADS_SHOW_FAILED = 166,
        SHOP_BUY_FAILED = 167,
        SHOP_CAN_BUY_FAILED = 168,
        SHOP_CURRENCY_INSUFFICIENT = 169,
        SHOP_ITEM_DAILY_MANUAL_REFRESH_COUNT_EXHAUSTED = 170,
        SHOP_ITEM_PURCHASE_LIMIT_DISABLED = 171,
        SHOP_ITEM_PURCHASE_LIMIT_EXCEEDED = 172,
        SHOP_PRODUCT_ID_EMPTY = 173,
        SHOP_PRODUCT_NOT_FOUND = 174,
        SHOP_PRODUCT_PRICE_INVALID = 175,
        SHOP_REWARD_APPLY_FAILED = 176,
        SHOP_REWARD_GROUP_EMPTY = 177,
        SHOP_SERVER_TIME_UNAVAILABLE = 178,
        SHOP_WALLET_UNAVAILABLE = 179,
        TREASURE_CHEST_NOT_FOUND = 180,
        TREASURE_GRADE_INVALID = 181,
        TREASURE_REWARD_APPLY_FAILED = 182,
        TREASURE_REWARD_EMPTY = 183,
        TREASURE_REWARD_GROUP_EMPTY = 184,
        VERSION_CHECK_NETWORK_FAILED = 185,
        VERSION_CHECK_PARSE_FAILED = 186,
        VERSION_CHECK_RESPONSE_EMPTY = 187,
        VERSION_CHECK_URL_NOT_CONFIGURED = 188,
    }
    ...
    public sealed class ITEM_HERO : IEntityKey<string>
    {
        ...
        public EQUIP_SLOT_TYPE initial_slot_00 { get; set; }
        public string initial_item_00 { get; set; } = string.Empty;
        public EQUIP_SLOT_TYPE initial_slot_01 { get; set; }
        public string initial_item_01 { get; set; } = string.Empty;
        public EQUIP_SLOT_TYPE initial_slot_02 { get; set; }
        public string initial_item_02 { get; set; } = string.Empty;
        public EQUIP_SLOT_TYPE initial_slot_03 { get; set; }
        public string initial_item_03 { get; set; } = string.Empty;
    ...
    public sealed class ITEM_HERO_LEVEL : IEntityKey<int>
    {
        ...
        public int levelup_count { get; set; }
        public CURRENCY_TYPE levelup_currency { get; set; }
    ...
    public sealed class ITEM_EQUIP : IEntityKey<string>
    {
        ...
        public string name_id { get; set; } = string.Empty;
        public string desc_id { get; set; } = string.Empty;
        public ITEM_GRADE_TYPE gradeType { get; set; }
        public EQUIP_TYPE equip_type { get; set; }
    ...
    public sealed class ITEM_EQUIP_LEVEL : IEntityKey<int>
    {
        ...
        public string item_id { get; set; } = string.Empty;
        public int item_level { get; set; }
        public string levelup_material { get; set; } = string.Empty;
        public int levelup_count { get; set; }
        public CURRENCY_TYPE levelup_currency { get; set; }
        public int levelup_price { get; set; }
        public UNIT_STAT_TYPE stat_type00 { get; set; }
