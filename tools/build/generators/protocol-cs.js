...
// Namespace: Devian.Protocol + static partial class {ProtocolName}
// </auto-generated>
 ...
 */
export function generateCSharpProtocol(spec, protocolName) {
    const lines = [];
    ...
    // Namespace: Devian.Protocol (block style)
    lines.push('namespace Devian.Protocol');
    lines.push('{');
